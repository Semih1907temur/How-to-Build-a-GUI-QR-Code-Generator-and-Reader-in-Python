...
class MyGUI(QMainWindow):
    ...
    def generate_code(self):
        ...
        # QR kodunu geçici bir dosyaya kaydediyoruz
        img = qr.make_image(fill_color="black", back_color="white")
        img.save("C:/Users/semih/PycharmProjects/myQrCodeProject/MyProject/currentQr.png")
        # Burada kaydedilen dosya geçici olarak kullanılacak

        # Pixmap ile görüntüyü yükleyip arayüzde gösteriyoruz
